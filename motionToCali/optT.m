...
options = optimset('MaxFunEvals',100000,'MaxIter',5000000);
estVec = estVec(2:end,1:3);
tranVec = fminsearch(@(estVec) systemProbT_new( sensorData, estVec, R),estVec, options);
